...
def example_save_configuration():
    ...
    try:
        # Save to YAML file
        save_thresholds_config(config, "backend/verification/config/custom_thresholds.yaml")
        print("Configuration saved to custom_thresholds.yaml")
        
        # Load it back to verify
        loaded_config = enhanced_load_thresholds_config("backend/verification/config/custom_thresholds.yaml")
